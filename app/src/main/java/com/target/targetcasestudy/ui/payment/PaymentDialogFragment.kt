...
class PaymentDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        submitButton.setOnClickListener {
            val text = if (validateCreditCard(creditCardInput.text.toString())) "valid" else "invalid"
            Toast.makeText(submitButton.context, "Card is $text", Toast.LENGTH_LONG).show()
        }
